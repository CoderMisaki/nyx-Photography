          ...
          >
            <div className="aspect-[4/5] sm:aspect-[3/4] overflow-hidden relative bg-surface-soft">
              <img decoding="async" fetchPriority="low"
                src={images[0].src}
                alt={images[0].title}
                className="w-full h-full object-cover gallery-img group-hover:scale-105 transition-transform duration-700 ease-editorial grayscale-[15%] group-hover:grayscale-0"
            ...
            >
              <div className="aspect-[1/1] overflow-hidden bg-surface-soft">
                <img decoding="async" fetchPriority="low"
                  src={img.src}
                  alt={img.title}
                  className="w-full h-full object-cover gallery-img group-hover:scale-110 transition-transform duration-500 ease-editorial"
                  onLoad={() => markImageCached(img.src)} loading="lazy"
                />
              </div>
