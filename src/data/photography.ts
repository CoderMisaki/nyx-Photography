...
export const CATEGORIES: Record<CategoryId, CategoryMeta> = {
  stadium: {
    ...
    number: '02',
    title: 'STADIUM',
    subtitle: 'The Atmosphere Before The Moment',
    description: 'Cinematic scale, roaring arena architecture, electric anticipation, and monumental athletic energy.',
    visualDirection: 'Cinematic + Panoramic + Wide Compositions',
